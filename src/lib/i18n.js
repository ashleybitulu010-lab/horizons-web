...
export const DICTS = {
  fr: {
    ...
    'settings.guideSection': 'Aide',
    'settings.relaunchGuide': 'Conseils de démarrage (optionnel)',
    'settings.guideCompleted': 'Pour gérer votre activité, parlez à Ashy dans le chat principal.',
    'settings.guideSkipped': 'Pour gérer votre activité, parlez à Ashy dans le chat principal.',
    'settings.guideActive': 'Pour gérer votre activité, parlez à Ashy dans le chat principal.',
    'settings.guidePending': 'Pour gérer votre activité, parlez à Ashy dans le chat principal.',
    'settings.guideOpened': 'Service client ouvert…',
    'settings.helpTip': 'Pour produits, stock, ventes et dépenses, utilisez Ashy dans le chat principal. Le Service client est réservé au support humain (compte, technique, abonnement).',
    'settings.prefs': 'Préférences',
    'settings.notifications': 'Notifications',
    'settings.notificationsHint': 'Préférence enregistrée sur votre compte (pas de notifications push navigateur)',
    ...
    'ashy.chat': 'Contactez le service client',
    'ashy.relaunch': 'Ouvrir le service client',
    'ashy.placeholderGuide': 'Votre message au service client…',
    'ashy.placeholder': 'Votre message au service client…',
    'ashy.copied': 'Copié',
    'ashy.forwardCopied': 'Copié pour transfert',
  },
  en: {
    'nav.guide': 'Customer support',
    ...
    'settings.guideSection': 'Help',
    'settings.relaunchGuide': 'Getting started tips (optional)',
    'settings.guideCompleted': 'To manage your activity, talk to Ashy in the main chat.',
    'settings.guideSkipped': 'To manage your activity, talk to Ashy in the main chat.',
    'settings.guideActive': 'To manage your activity, talk to Ashy in the main chat.',
    'settings.guidePending': 'To manage your activity, talk to Ashy in the main chat.',
    'settings.guideOpened': 'Customer support opened…',
    'settings.helpTip': 'For products, stock, sales and expenses, use Ashy in the main chat. Customer support is for human help (account, technical, billing).',
    'settings.prefs': 'Preferences',
    'settings.notifications': 'Notifications',
    'settings.notificationsHint': 'Account preference saved (no browser push notifications)',
    ...
    'ashy.chat': 'Contact customer support',
    'ashy.relaunch': 'Open customer support',
    'ashy.placeholderGuide': 'Your message to customer support…',
    'ashy.placeholder': 'Your message to customer support…',
    'ashy.copied': 'Copied',
